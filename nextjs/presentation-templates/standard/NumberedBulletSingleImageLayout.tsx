        ...
        <div className="grid grid-cols-[34%_33%_33%] h-[calc(100%-64px)] mt-1">
              ...
              {bullets.map((b, i) => (
                <li key={i} className="flex items-center justify-between">
                  <div className="w-[85%]">
                    ...
                    <p className="mt-2 text-[16px] leading-relaxed " style={{ color: 'var(--text-body-color, #4e4e4e)' }}>
                      {b.body}
                    </p>
                  </div>
          ...
          <div className="pl-10 pr-12 pt-16">
            <div className="max-w-[560px] mx-auto">
              ...
              <p className="mt-6 text-[16px] leading-relaxed " style={{ color: 'var(--text-body-color, #4e4e4e)' }}>
