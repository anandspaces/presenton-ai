...
return (
    ...
    <div className="px-12">
        ...
        <p className="mt-5 text-[16px] leading-[1.6] max-w-[1020px] " style={{ color: 'var(--text-body-color, #4e4e4e)' }}>
    ...
    <div className="px-10 mt-10">
        ...
        {cards.map((card, idx) => {
            ...
            <div key={idx} className="rounded-xl border shadow-[0_24px_60px_rgba(0,0,0,0.08)]" style={{ backgroundColor: 'var(--card-background-color, #FFFFFF)', borderColor: 'rgba(0,0,0,0.06)' }}>
                ...
                <p className="mt-6 text-[16px] leading-[1.6] " style={{ color: 'var(--text-body-color, #4e4e4e)' }}>
                    {card.description}
                </p>
                </div>
            </div>
