      ...
      >
        ...
        <div className="px-12 pt-6 pb-2">
          <div className="flex items-center gap-3">
            ...
            {  (slideData as any)?.__companyName__ && <span
              className="text-[16px] "
              style={{ color: "var(--text-body-color, #4e4e4e)" }}
            >
        ...
        <div className="grid grid-cols-[58%_42%] gap-10 px-12 pt-4 pb-10 items-start">
          <div className="pt-4">
            ...
            <p className="mt-5 text-[16px] leading-[1.6] max-w-[620px] " style={{ color: "var(--text-body-color, #4e4e4e)" }}>{slideData?.paragraph}</p>
            ...
            {slideData?.introCard?.enabled && (
              ...
              >
                ...
                <div className="flex items-baseline gap-3">
                  ...
                  <span className="text-[14px]" style={{ color: 'var(--text-body-color, #4e4e4e)' }}>
